...
public class GestionCompteBean implements Serializable{
	...
	public List<Compte> findAllComptesBdd(){
		...
		if(filtreClientId > 0)
			...
			liste_comptes = compteDAO.getAll(pIdCons);
		}
...
///////////////////////////////////////////////////////////////////////// SECTION  RETRAIT \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
	...
	public void initialiserCompteAvecId (ActionEvent event) {
		...
		// 3. instanciation d'un nouveau objet compte vide
		Compte compteAdd = new Compte();
		
		// 4. ajout de l'id du compte
		compteAdd.setId_compte(compteID);
